...
#ifndef COMMUNICATION_CLIENT_LISTENER_H
#define COMMUNICATION_CLIENT_LISTENER_H
...
private:
    ...
    /**
     * 数据处理线程，对接收到的 Socket 数据进行处理
     */
    std::shared_ptr<HandlerThread> data_handle_thread_;

    /**
     * data_handle_thread_ 的互斥锁
     */
    std::mutex data_handle_thread_mutex_;
...
#endif //COMMUNICATION_CLIENT_LISTENER_H
