...
#ifndef THREAD_SMART_THREAD_H
#define THREAD_SMART_THREAD_H
...
public:
     ...
     * 创建对象的唯一方式
     */
    static SmartThread *NewInstance(Runnable runnable);
...
private:
     ...
     *
     * 唯一创建对象的方式是 SmartThread::NewInstance();
     */
